...
protected:
  ...
  Bool_t IsTrackSelected(AliReducedTrackInfo* track, Float_t* values=0x0);
  Bool_t IsTrackPrefilterSelected(AliReducedTrackInfo* track, Float_t* values=0x0);
  Bool_t IsPairSelected(Float_t* values);
  Bool_t IsPairPreFilterSelected(Float_t* values);
  UInt_t CheckReconstructedLegMCTruth(AliReducedTrackInfo* ptrack, AliReducedTrackInfo* ntrack);
  UInt_t CheckReconstructedLegMCTruth(AliReducedTrackInfo* track);
  ...
  void    LoopOverMCTracks(Int_t trackArray =1, Bool_t fillHistos = kTRUE);
  ...
  ClassDef(AliReducedAnalysisJpsi2eeMult,5);
};
